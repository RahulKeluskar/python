...
class Superhero():
    ...
    def __getitem__(self, key):
        ''' Fetch the move located at the key index of the superhero in case the move doesnt exist at that location returns -1 '''
        try:
            return self.moves[key]
        except IndexError:
            print('The given index doesnot exist in the moves')
            return -1
